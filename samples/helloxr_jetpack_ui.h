...
public:
    ...
    static constexpr float HEIGHT_METERS = WIDTH_METERS * float(PIXEL_HEIGHT) / float(PIXEL_WIDTH);
    ...
    void requestExtensions(bool requested, std::function<bool(char const*)> const& supports,
